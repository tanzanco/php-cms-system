...
<?php
/* require 'vendor/autoload.php';  USE >ENV FILES TO SECURE IMPORTANT KEYS AND ALL AND PUT ENV FILE IN GITIGNORE TO SECURE 
$options = [
    'cluster': 'us2',
    'encrypted': true
]
...
<!-- <script src="pusher js link"></script> -->
